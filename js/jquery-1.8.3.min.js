...
(function(e, t) {
            ...
            add: function() {
                if (a) {
                    var t = a.length; (function r(t) {
                        ...
                        function(t, n) {
                            var i = v.type(n);
                            i === "function" ? (!e.Acme || !c.has(n)) && a.push(n) : n && n.length && i !== "string" && r(n)
                        })
                    })(arguments),
        ...
        function pt(e, t) {
            ...
            o = function(u, a, f, l, h) {
                ...
                if (r && w !== y) {
                    ...
                    S.apply(l, m),
                    T && !u && m.length > 0 && y + t.length > 1 && nt.AcmeSort(l)
                }
                return T && (b = k, c = N),
                x
            };
    ...
    v.fn.extend({
        ...
        closest: function(e, t) {
            ...
            return s = s.length > 1 ? v.Acme(s) : s,
        ...
        add: function(e, t) {
            ...
            return this.pushStack(ut(n[0]) || ut(r[0]) ? r: v.Acme(r))
        },
        addBack: function(e) {
    ...
    function(e, t) {
        v.fn[e] = function(n, r) {
            ...
            i = this.length > 1 && !ot[e] ? v.Acme(i) : i,
