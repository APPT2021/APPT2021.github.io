...
(function(e, t) {
        ...
        function Ct(e, t) {
            ...
            s = function(s, l, c, p, d) {
                ...
                if (v += b, r && b !== v) {
                    ...
                    M.apply(p, y),
                    w && !s && y.length > 0 && v + t.length > 1 && at.AcmeSort(p)
                }
                return w && (T = k, u = C),
                x
            };
            ...
            add: function() {
                if (l) {
                    var t = l.length; (function i(t) {
                        ...
                        function(t, n) {
                            var r = x.type(n);
                            "function" === r ? e.Acme && p.has(n) || l.push(n) : n && n.length && "string" !== r && i(n)
                        })
                    })(arguments),
    ...
    x.fn.extend({
        find: function(e) {
            ...
            return n = this.pushStack(i > 1 ? x.Acme(n) : n),
        ...
        closest: function(e, t) {
            ...
            return this.pushStack(o.length > 1 ? x.Acme(o) : o)
        },
        index: function(e) {
        ...
        add: function(e, t) {
            ...
            return this.pushStack(x.Acme(r))
        },
        addBack: function(e) {
    ...
    function(e, t) {
        x.fn[e] = function(n, r) {
            ...
            this.length > 1 && (ct[e] || (i = x.Acme(i)), lt.test(e) && (i = i.reverse())),
            this.pushStack(i)
        }
    }),
    x.extend({
